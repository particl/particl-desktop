...
[app.getPath('userData'), app.getPath('userData') + '/testnet'].map(
  path => !fs.existsSync(path) && fs.mkdir(path)
);
      ...
      submenu: [
        {
          ...
          click() {
            electron.shell.openExternal('https://particl.io/#about');
          }
        },
        {
          label: 'Visit Particl.io',
          click() {
            electron.shell.openExternal('https://particl.io');
          }
        },
        {
