...
import { MainState, WalletInfoState, WalletStakingState, WalletUTXOState } from './store/main.state';
...
@NgModule({
  ...
  imports: [
    MainRoutingModule,
    NgxsModule.forFeature([MainState, WalletInfoState, WalletStakingState, WalletUTXOState]),
    CommonModule,
    CoreUiModule
  ],
  providers: [
