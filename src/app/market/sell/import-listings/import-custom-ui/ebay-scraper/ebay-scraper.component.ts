...
@Component({
  selector: 'app-import-custom-ui-ebay-scraper',
  templateUrl: './ebay-scraper.component.html',
  styleUrls: ['./ebay-scraper.component.scss']
})
export class ImportCustomUiEbayComponent {
  @Input() import: any;
