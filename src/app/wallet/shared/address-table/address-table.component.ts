...
export class AddressTableComponent implements OnInit {
  ...
  public deleteAddress(label: string, address: string) {
    const dialogRef = this.dialog.open(DeleteConfirmationModalComponent, {panelClass: 'small-modal'});
  ...
  openQrCodeModal(address: Object) {
    const dialogRef = this.dialog.open(QrCodeModalComponent, {panelClass: 'small-modal'});
