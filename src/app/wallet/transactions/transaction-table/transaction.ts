  ...
  walletconflicts: Object[];
    ...
    constructor( txid: string, address: string, category: string, amount: number, blockhash: string,
                 blockindex: number, confirmations: number, time: number, comment: string, vout: number) {
      this.txid = txid;
